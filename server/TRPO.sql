...
--
-- Name: courstask; Type: TABLE; Schema: base; Owner: postgres
--

CREATE TABLE base.courstask (
    inventory_id integer,
    tasklist_id integer
);


ALTER TABLE base.courstask OWNER TO postgres;
...
CREATE TABLE base.taskresult (
    ...
    validation character varying(255) DEFAULT 'Не выполнено'::character varying NOT NULL,
...
--
-- Data for Name: courstask; Type: TABLE DATA; Schema: base; Owner: postgres
--

COPY base.courstask (inventory_id, tasklist_id) FROM stdin;
\.
...
COPY base.taskfile (taskresult_id, file_id) FROM stdin;
\.
...
COPY base.tasknotification (taskresult_id, user_id) FROM stdin;
\.
...
COPY base.taskresult (id, task_id, validation, create_date, result) FROM stdin;
\.
...
SELECT pg_catalog.setval('base.taskresult_id_seq', 1, false);
...
--
-- Name: courstask courstask_inventory_id_fkey; Type: FK CONSTRAINT; Schema: base; Owner: postgres
--

ALTER TABLE ONLY base.courstask
    ADD CONSTRAINT courstask_inventory_id_fkey FOREIGN KEY (inventory_id) REFERENCES base.inventory(id);


--
-- Name: courstask courstask_tasklist_id_fkey; Type: FK CONSTRAINT; Schema: base; Owner: postgres
--
...
--
-- Name: taskfile taskfile_taskresult_id_fkey; Type: FK CONSTRAINT; Schema: base; Owner: postgres
--
